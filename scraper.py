...
async def find_most_recent_hs_profile(page) -> tuple:
    """
    ENHANCED: JavaScript-based dropdown with FORCED visibility.
    Returns (hs_url, hs_name, hs_id)
    """
    try:
